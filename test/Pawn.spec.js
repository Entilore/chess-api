...
export class PawnTest {
	...
	movingToAnotherPiece () {
		let whitePieces = new Map([[this.whitePawn, [[1, 1], [2, 2]]]])
		let blackPieces = new Map([[this.blackPawn, [[0, 2], [1, 2], [0, 1]]]])
		...
		this.whitePawn.isCellAccessible(1, 1, 2, 2, game).should.be.false
		this.blackPawn.isCellAccessible(0, 2, 0, 1, game).should.be.false
	}
